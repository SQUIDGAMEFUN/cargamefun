...
onc = board.analog[0]
onh = board.analog[1]
btn = board.get_pin('d:13:i')
btn.enable_reporting()
onc.enable_reporting()
onh.enable_reporting()
...
class Car():
    def __init__(self,x=0,y=0,dx=0,dy=0):
        ...
        car_images_path = resource_path('asset/car')
        ...
        crash_image_path = resource_path('asset/crash.png')
        crash_sound_path = resource_path('asset/crash.wav')
        collision_sound_path = resource_path('asset/collision.wav')
        engine_sound_path = resource_path('asset/engine.wav')
...
class Game():
    def __init__(self):
        # 게임 리소스 로드
        menu_image_path = resource_path('asset/menu_car.png')
        self.image_intro = pygame.image.load(menu_image_path)
        pygame.mixer.music.load(resource_path('asset/race.wav'))
        font_path = resource_path('asset/NanumGothicCoding-Bold.ttf')
    ...
    def process_events(self):
        ...
        if self.menu_on and btn.read() == False:
...
def main():
    ...
    while not done:
        ...
        if game.menu_on:
            ...
            print("Vertical" + str(onc.read()))
            print("Horizontal" + str(onh.read()))
